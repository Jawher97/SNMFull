...
export class HelpCenterService
{
    ...
    {
        return this._httpClient.get<FaqCategory[]>('api/common/help-center/faqs').pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<FaqCategory[]>('api/common/help-center/faqs', {
            params: {slug}
        }).pipe(
            tap((response: any) => {
                this._faqs.next(response);
    ...
    {
        return this._httpClient.get<GuideCategory[]>('api/common/help-center/guides', {
            params: {limit}
        }).pipe(
            tap((response: any) => {
    ...
    {
        return this._httpClient.get<GuideCategory>('api/common/help-center/guide', {
            params: {
                categorySlug,
                guideSlug
            }
