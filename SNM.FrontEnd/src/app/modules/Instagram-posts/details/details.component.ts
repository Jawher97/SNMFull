...
export class PostsDetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // Add
      ...
      const post: Post = {
        ...
        caption: function (imageURL: (imageURL: any, caption: any) => Observable<any>, caption: any): Observable<any> {
          throw new Error('Function not implemented.');
        },
        imageURL: function (imageURL: any, caption: any): Observable<any> {
          throw new Error('Function not implemented.');
        }
      };
  ...
  */
   ...
   */
    publishOnInstagram(post: Post): void {
      const caption = post.message; // Use the post's message as the caption
      const image_url = 'https://th.bing.com/th/id/R.e1707c345d5ac10c80a674030e606643?rik=pOsTg5KBoLuNvw&riu=http%3a%2f%2fwww.snut.fr%2fwp-content%2fuploads%2f2015%2f08%2fimage-de-paysage.jpg&ehk=1O5SWKkGpZ8yU%2b%2fAnLXG1v8k6BKxgyiXgHbOWBW1ir0%3d&risl=1&pid=ImgRaw&r=0'; // Replace with the URL of the image to publish
      
      this.instagramService.publishPhoto(caption, image_url).subscribe({
        next: (response) => {
          // Handle success response
          console.log('Post published on Instagram:', response);
        },
        error: (error) => {
          // Handle error
        ...
        complete: () => {
          // Handle completion
          console.log('Publishing post on Instagram completed.');
        }
      });
    }
    // ...
  ...
  uploadImages = (files) => {
    ...
    this._uplodeService.uploadFile(filesToUpload);
