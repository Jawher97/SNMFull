...
namespace Multitenancy.Infrastructure.Multitenancy.Tests
{
    public class ConnectionStringSecurerTests : TestBed<TestFixture>
    {
        private const string Mssql ="Data Source=localhost;Initial Catalog=preReleaseTest;Trusted_Connection=True;MultipleActiveResultSets=true;User ID=sa;Password=123456";
