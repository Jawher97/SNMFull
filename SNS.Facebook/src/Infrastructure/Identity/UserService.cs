...
using SNS.Facebook.Application.Common.Exceptions;
using SNS.Facebook.Application.Common.FileStorage;
using SNS.Facebook.Application.Common.Interfaces;
using SNS.Facebook.Application.Common.Mailing;
using SNS.Facebook.Application.Common.Models;
using SNS.Facebook.Application.Common.Specification;
using SNS.Facebook.Application.Identity.Users;
using SNS.Facebook.Domain.Identity;
